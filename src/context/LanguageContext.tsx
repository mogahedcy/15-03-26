...
export const translations = {
    ar: {
        ...
        location: 'جدة طريق المكرونة العزيزية - منطقة مكة المكرمة',

        // New: About Section
        aboutTitle: 'خبرة عريقة في عالم المظلات والسواتر',
        aboutDesc: 'ديار جدة العالمية هي مؤسسة رائدة في المملكة العربية السعودية، متخصصة في ابتكار حلول التظليل والإنشاءات المعدنية. نحن نجمع بين الأصالة المعمارية والتقنيات الحديثة لنقدم لك جودة تدوم طويلاً.',
        aboutFeat1: 'ضمان يصل إلى 10 سنوات',
        aboutFeat2: 'خامات ألمانية وكورية أصلية',
        aboutFeat3: 'إشراف فني وهندسي دقيق',

        // New: Contact Form Services
        selectService: 'اختر الخدمة...',
        optCarShades: 'مظلات سيارات',
        optPergolas: 'برجولات وجلسات',
        optTents: 'خيام وبيوت شعر',
        optSawatr: 'سواتر وخصوصية',
        optPanel: 'ساندوتش بانل',
        optOther: 'أخرى / طلب خاص',
        ...
        workingHoursDesc: 'على مدار 24 ساعة يومياً',
    },
    en: {
        ...
        location: 'Al-Makarunah Road, Al-Aziziyah - Jeddah - Makkah Region',

        // New: About Section
        aboutTitle: 'Long History in Shading & Structures',
        aboutDesc: 'Diyar Jeddah Global is a leading institution in Saudi Arabia, specializing in innovative shading solutions and metal constructions. We combine architectural heritage with modern technologies to provide you with lasting quality.',
        aboutFeat1: 'Up to 10 Years Warranty',
        aboutFeat2: 'Original German & Korean Materials',
        aboutFeat3: 'Precise Engineering Supervision',

        // New: Contact Form Services
        selectService: 'Select Service...',
        optCarShades: 'Car Shades',
        optPergolas: 'Pergolas & Gazebos',
        optTents: 'Tents & Hair Houses',
        optSawatr: 'Sawatr (Privacy Screens)',
        optPanel: 'Sandwich Panel',
        optOther: 'Other / Custom Request',
