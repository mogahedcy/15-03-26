        ...
        <main className="min-h-screen bg-slate-50 relative">
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/car-shades/car-shades-jeddah.jpg"
                    ...
                    <div className="space-y-8">
                        <div className="flex flex-col md:flex-row gap-6 items-start">
                            <div className="w-full md:w-1/3 h-48 relative rounded-lg overflow-hidden shrink-0">
                                <Image src="/images/car-shades/car-shades-jeddah-1.jpg" alt={t('csType1Title' as any)} fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover" />
                            </div>
                            <div>
                        ...
                        <div className="flex flex-col md:flex-row gap-6 items-start">
                            <div className="w-full md:w-1/3 h-48 relative rounded-lg overflow-hidden shrink-0">
                                <Image src="/images/car-shades/car-shades-jeddah-2.jpg" alt={t('csType2Title' as any)} fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover" />
                            </div>
                            <div>
                        ...
                        <div className="flex flex-col md:flex-row gap-6 items-start">
                            <div className="w-full md:w-1/3 h-48 relative rounded-lg overflow-hidden shrink-0">
                                <Image src="/images/car-shades/car-shades-jeddah-3.jpg" alt={t('csType3Title' as any)} fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover" />
                            </div>
                            <div>
