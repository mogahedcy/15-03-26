      ...
      */}
            ...
            >
                <div className="max-w-md mx-auto w-full">
                    ...
                    {link ? (
                        <Link href={link} className="mt-8 px-8 py-3 bg-brand-primary text-white text-sm font-bold tracking-widest uppercase hover:bg-brand-accent transition-colors w-max block shadow-md hover:shadow-lg text-center" style={{ width: 'fit-content' }}>
