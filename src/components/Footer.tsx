...
export default function Footer() {
    ...
    const socialLinks = [
        { icon: BsWhatsapp, href: 'https://wa.me/966553719009', label: isRtl ? 'واتساب' : 'WhatsApp', color: 'hover:text-green-500' },
        { icon: BsInstagram, href: 'https://www.instagram.com/aldiyarglobal', label: isRtl ? 'انستقرام' : 'Instagram', color: 'hover:text-pink-500' },
        { icon: FaTiktok, href: 'https://vm.tiktok.com/ZShKSH6o9/', label: isRtl ? 'تيك توك' : 'TikTok', color: 'hover:text-black' }
    ];
    ...
    const servicesLinks = [
        ...
        { name: t('sawatrTitle' as any), path: '/services/sawatr' },
    ];
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        <Link href="/" className="inline-block mb-6 relative w-32 h-16">
                            ...
                            <Image
                                src="/logo.svg"
                                alt="شعار ديار جدة العالمية في تذييل الموقع"
                                fill
